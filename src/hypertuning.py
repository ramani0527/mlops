...
# Applying GridSearchCV  we are doing 5 folds data to avoid over fitting
...
with mlflow.start_run() as parent:
    ...
    # in order to log your train and test data you need to create an object then pass it as an input using pandas
    ...
    # Log the best model by calling this best estimator method
    mlflow.sklearn.log_model(grid_search.best_estimator_, "random_forest")

    # Set tags
    mlflow.set_tag("author", "Ramani M")
